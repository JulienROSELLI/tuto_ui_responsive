    ...
    <Section id="how-to-use">
      <div className="container">
        <Heading
          ...
          text="Brainewave unlocks the potential of AI-powered applications"
        />
        <div className="relative">
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            <div className="w-full h-full absolute pointer-events-none top-0 left-0 md:w-3/5 xl:w-auto">
              <img
            ...
            <div className="relative z-1 max-w-[17rem]">
              ...
              <ul className="body-2">
                {brainwaveServices.map((item) => (
                  <li
                    key={item}
                    className="flex items-start py-4 border-t border-n-6 mb-3"
                  >
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="py-12 px-4 xl:px-8">
                ...
                <p className="body-2 mb-[2rem] text-n-3 ">
                  The world's most powerfull AI photo and video art generation
